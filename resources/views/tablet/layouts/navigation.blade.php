        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <button data-drawer-target="top-bar-sidebar" data-drawer-toggle="top-bar-sidebar"
                        ...
                        class="lg:hidden text-heading bg-transparent box-border border border-transparent hover:bg-neutral-secondary-medium focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded-base text-sm p-2 focus:outline-none">
...
<aside id="top-bar-sidebar"
       class="fixed top-0 left-0 z-35 w-64 h-full transition-transform -translate-x-full lg:translate-x-0"
       aria-label="Sidebar">
